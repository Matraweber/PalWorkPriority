...
Write-Host ""
Write-Host ""
Write-Host "Launch Palworld and press Ctrl+F10 inside a base."
Write-Host ""
Write-Host "If you are ALSO subscribed to the Workshop item, Palworld manages this mod"
Write-Host "and will fight this script. On launch it rewrites mods.txt from its own"
Write-Host "ActiveModList, so a mod left switched off under Options > Mod Management goes"
Write-Host "back to 0 and never loads, whatever this script wrote. It also installs the"
Write-Host "Workshop copy over Scripts\, keeping .lua.bak files of what it replaced."
Write-Host ""
Write-Host "Switch it on under Options > Mod Management once, and keep the Workshop"
Write-Host "content folder in step with this repo, or the two copies will disagree."
